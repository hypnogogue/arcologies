...
function structures.init()
  ...
  structures:register("SHRINE",       { "NOTES", "VELOCITY", "PAN" })
  structures:register("GATE",         {})
  structures:register("RAVE",         { "METABOLISM", "OFFSET" })
  structures:register("TOPIARY",      { "INDEX", "NOTE COUNT", "NOTES", "TOPOGRAPHY", "VELOCITY", "PAN" })
  structures:register("DOME",         { "METABOLISM", "OFFSET", "PULSES" })
  structures:register("MAZE",         { "METABOLISM", "OFFSET", "PROBABILITY" })
  structures:register("CRYPT",        { "INDEX", "LEVEL", "PAN" })
  structures:register("VALE",         { "RANGE MIN", "RANGE MAX", "VELOCITY", "OUTPUT", "DURATION", "CHANNEL", "DEVICE", "PAN" })
  ...
  structures:register("FRACTURE",     { "NOTES", "RANGE MIN", "RANGE MAX", "OUTPUT", "DURATION", "CHANNEL", "DEVICE", "PAN" })
